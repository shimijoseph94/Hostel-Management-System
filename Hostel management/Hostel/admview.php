...
<tr><th>Reg_id</th><th>Name</th><th>Age</th><th>Fathersname</th><th>Mothersname</th><th>Emailid</th><th>HouseName</th><th>Place</th><th>Department</th><th>Branch</th><th>Semester</th><th>Status</th></tr>


	
	 <?php
 $sql1=("select r.*,d.Dept_name,s.Sem_name,b.Branch_name from registration r join department d on r.Dept_id=d.Dept_id
 join semester s on s.Sem_id=r.Sem_id join Branch B on B.branch_id=r.Branch_id where `allocation_status`=0" );
