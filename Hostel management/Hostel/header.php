          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                	<li><a href="studview.php">View details</a></li>
					<li><a href="empreg.php">Register</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="adr1.php">Add Room</a></li>
				<li><a href="romm1.php">View Room Details</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="allotdet1.php">View Details</a></li>
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="Addmessfees1.php">Add Mess Fees</a></li>
              </ul>
            </li>
