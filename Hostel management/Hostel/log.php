...
if(isset($_POST['submit']))
{
	...
	header("location:dashboard1.php");	//home page or the dashboard page to be redirected
	}
           	  ...
           	  <h3>Login</h3>
              	...
              	<div id="cp_contact_form">
                    ...
                    <form method="post" name="contact" action="">
                            ...
                            <label for="Name">Username:</label> <input name="username" type="text" class="input_field" id="username" maxlength="60" />
