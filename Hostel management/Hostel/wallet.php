...
//                                }
   ?>
                        ...
                        <!--<input type="text" placeholder="Amount" name="gl_amt" class="form-control input-md" style="width:200px" id="gl_amt" required>-->
                            ...
                            <div class="">
                                <button type="button"  class="button"><a href="buyerhome.php" style="color:white;text-decoration: none;">CANCEL</a></button>
                                <input type="submit" class="button" id="gl_wallet_addbtn" name="gl_wallet_addbtn" value="PAY"/>
                            </div>
                    </div>
                </form>
    </div>
